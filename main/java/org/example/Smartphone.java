...
public class Smartphone {
    ...
    public Smartphone(String apple, String s, short i, String s1, String s2) {

    }

    public void Smartphone(String marca, String modelo, short anoLancamento, String memoriaRAM, String armazenamento) {
        this.marca = marca;
        this.modelo = modelo;
